    ...
    : Box(name, parent)
{
    ...
    Input(initBiomassStruct).imports("plantReset[biomassStruct]");
    Input(initBiomassCRes).imports("plantReset[biomassCRes]");
    Input(initBiomassNRes).imports("plantReset[biomassNRes]");
    Input(supplyReservesC).imports("allocation[supplyReservesC]");
    Input(supplyReservesN).imports("allocation[supplyReservesN]");
